...
- Version 2: Added extra contrasts + reworked PCA
...
```{ojs}
viewof ora_sel = Inputs.select(["C_1_vs_C_0", "C_4_vs_C_0", "C_24_vs_C_0", "C_24_vs_C_1", "C_24_vs_C_4", "C_4_vs_C_1"], { label: "Choose Contrast" })
html`<p></p>`
```
