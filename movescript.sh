...
rsync -harv --prune-empty-dirs --include "*/" --include="*.pdf" --include=".png" --include="*.svg" --exclude="*" /Users/vinva957/wharf_mnt/Results /Users/vinva957/Desktop/NBIS/Projects/SMS-5986-21-atac --delete
